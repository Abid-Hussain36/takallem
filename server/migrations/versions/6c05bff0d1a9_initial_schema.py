...
Revision ID: 6c05bff0d1a9
Revises: 
Create Date: 2026-01-09 16:52:48.802868
...
def upgrade() -> None:
    ...
    sa.Column('language', sa.Enum('ARABIC', 'SPANISH', 'FRENCH', name='availablelanguage'), nullable=False),
    ...
    sa.Column('course_name', sa.Enum('BEGINNER_ARABIC', 'INTERMEDIATE_ARABIC', 'ADVANCED_ARABIC', name='availablecourse'), nullable=False),
    sa.Column('image', sa.String(), nullable=False),
    sa.Column('text_color', sa.String(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('language_id', sa.Integer(), nullable=False),
    sa.Column('dialect', sa.Enum('MSA', 'LEVANTINE', 'EGYPTIAN', name='availabledialect'), nullable=False),
    sa.Column('image', sa.String(), nullable=False),
    sa.Column('text_color', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['language_id'], ['languages.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_dialects_id'), 'dialects', ['id'], unique=False)
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('course', sa.Enum('BEGINNER_ARABIC', 'INTERMEDIATE_ARABIC', 'ADVANCED_ARABIC', name='availablecourse'), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_dialects_id'), table_name='dialects')
