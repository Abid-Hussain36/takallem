...
class LetterJoiningProblemSet(Resource):
    __tablename__ = "letter_joining_problem_sets"
    ...
    def to_model(self) -> LetterJoiningProblemSetResponse:
        return LetterJoiningProblemSetResponse(
            id=self.id,
